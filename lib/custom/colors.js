...
function monochromatic_complementary(start) {
  let color2 = [start[0],start[1]/2,start[2]/2];
  let color3 = [start[0],start[1]/4,start[2]/4];
  let color4 = [(start[0]+180)%360,start[1]/2,start[2]/2];
  let color5 = [(start[0]+180)%360,start[1]/4,start[2]/4];
  let palette = [start,color2,color3,color4,color5];
  return palette;
}
